...
import ECommerceSection from './sidebar-sections/ECommerceSection';
import SettingsSection from './sidebar-sections/SettingsSection';
import TeamSection from './sidebar-sections/TeamSection';
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname === '/dashboard' && 'bg-gray-900'}`}>
                <NavLink exact to="/dashboard" className={`block text-gray-200 hover:text-white truncate transition duration-150 ${pathname === '/dashboard' && 'hover:text-gray-200'}`}>
              ...
              {/* <SidebarLinkGroup activecondition={pathname.includes('ecommerce')}>
                {(handleClick, open) => {
                  return <ECommerceSection handleClick={handleClick} open={open} pathname={pathname} sidebarExpanded={sidebarExpanded} setSidebarExpanded={setSidebarExpanded} />
                }}
              </SidebarLinkGroup> */}
              {/* Campaigns */}
              ...
              {/* <SidebarLinkGroup activecondition={pathname.includes('team')}>
                {(handleClick, open) => {
                  return <TeamSection handleClick={handleClick} open={open} pathname={pathname} sidebarExpanded={sidebarExpanded} setSidebarExpanded={setSidebarExpanded}/>
                }}
              </SidebarLinkGroup> */}
              {/* Messages */}
              ...
              <SidebarLinkGroup activecondition={pathname.includes('settings')}>
                {(handleClick, open) => {
                  return <SettingsSection handleClick={handleClick} open={open} pathname={pathname} sidebarExpanded={sidebarExpanded} setSidebarExpanded={setSidebarExpanded}/>
                }}
              </SidebarLinkGroup>
              {/* Utility */}
